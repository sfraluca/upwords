...
@include('header')
            ...
            <section class="contact-page-area section-gap">
									...
									<div class="col-lg-8">
									<form class="form-area " action="{{ route('update_vacancy', [$jobs->id, app()->getLocale()]) }}" method="post" class="contact-form text-right">
									{{csrf_field()}}
									<div class="row">	
									...
									@endif    
									<label for="Smalltitle">@lang('header.subtitle')</label>
