                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card-body">
                                    ...
                                    {{csrf_field()}}
                                        <div class="form-group">
                                            ...
                                            <input id="inputTitle" type="text" name="title" data-parsley-trigger="change" required=""  autocomplete="off" class="form-control">
                                            @if ($errors->has('title'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputEmploy" type="text" name="employment_type" data-parsley-trigger="change" required=""autocomplete="off" class="form-control">
						 ...
						 ></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputName" type="text" name="name" data-parsley-trigger="change" required=""  autocomplete="off" class="form-control">
                                            @if ($errors->has('name'))
                                                <span class="invalid-feedback" role="alert">
